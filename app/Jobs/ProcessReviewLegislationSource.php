...
class ProcessReviewLegislationSource implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(
        AnalyzeLegislationSource $analyze,
        PersistLegislationSourceState $state,
    ...
    private function handleEnrichment(
        ...
        $result = $analyze->enrich($document, $document->review->jurisdiction_id, (string) ($extraction['raw_text'] ?? ''), [
